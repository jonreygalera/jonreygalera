...
const timeline : TimelinePost[] = [
    {
        id: 15,
        title: 'nmitd/oauth — My First Private Composer Package',
        date: '2021',
        fullDate: '2021',
    ...
    {
        id: 12,
        title: 'Loop Moderation v2 — Upgrading Content Moderation Workflows',
        date: '2021',
        fullDate: '2021',
    ...
    {
        id: '10',
        title: 'Creating My Second NPM Package: ar-queue-task',
        date: '2021',
        fullDate: '2021',
        description: 'Experimented with creating a queue system as an NPM package using JavaScript to learn package development and task queuing.',
        slug: 'ar-queue-task-npm-package',
